...
public class Controller implements Initializable {
    @FXML
    public Button btn_ja;
    @FXML
    public Button btn_majd;
    @FXML
    ...
    public sample.Server server ;

    @Override
    public void initialize(URL location , ResourceBundle resources) {
        btn_ja.setOnAction(new EventHandler<ActionEvent>(){

            @Override
            public void handle(ActionEvent event) {
                server = new sample.Server(3000);
